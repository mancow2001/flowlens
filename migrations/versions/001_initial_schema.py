...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("connections_in", sa.BigInteger(), nullable=False, server_default="0"),
        sa.Column("connections_out", sa.BigInteger(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("connections_total", sa.BigInteger(), nullable=False, server_default="0"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
