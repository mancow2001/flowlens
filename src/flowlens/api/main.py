...
def create_app() -> FastAPI:
    ...
    # Include routers
    from flowlens.api.routers import admin, alert_rules, alerts, analysis, assets, changes, classification, dependencies, maintenance, saved_views, settings, topology, ws
